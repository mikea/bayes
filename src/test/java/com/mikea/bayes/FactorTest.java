...
public class FactorTest {
    ...
    public void testProduct() throws Exception {
        ...
        assertEquals("Factor({1(2), 2(2)}, [0.0649, 0.045099999999999994, 0.1958, 0.6942])", f1.product(f2).toString());
        assertEquals("Factor({1(2), 2(2)}, [0.0649, 0.045099999999999994, 0.1958, 0.6942])", f2.product(f1).toString());

        assertEquals("Factor({1(2), 2(2), 3(2)}):\n" +
                "{1=0, 2=0, 3=0}: 0.0429\n" +
                "{1=0, 2=0, 3=1}: 0.0671\n" +
                "{1=0, 2=1, 3=0}: 0.0066\n" +
                "{1=0, 2=1, 3=1}: 0.1034\n" +
    ...
    public void testMarginalize() throws Exception {
        ...
        assertEquals("Factor({1(2)}, [1.0, 1.0])", f.toString());
    }
    ...
    public void testInducedMarkovNetwork() throws Exception {
        ...
        assertEquals("DataGraphImpl{isDirected=false, [\n" +
                "    D<->G:[Factor({G(3), I(2), D(2)}, [0.3, 0.05, 0.9, 0.5, 0.4, 0.25, 0.08, 0.3, 0.3, 0.7, 0.02, 0.2])]\n" +
                "    D<->I:[Factor({G(3), I(2), D(2)}, [0.3, 0.05, 0.9, 0.5, 0.4, 0.25, 0.08, 0.3, 0.3, 0.7, 0.02, 0.2])]\n" +
                "    G<->I:[Factor({G(3), I(2), D(2)}, [0.3, 0.05, 0.9, 0.5, 0.4, 0.25, 0.08, 0.3, 0.3, 0.7, 0.02, 0.2])]\n" +
                "    G<->L:[Factor({L(2), G(3)}, [0.1, 0.4, 0.99, 0.9, 0.6, 0.01])]\n" +
                "    I<->S:[Factor({S(2), I(2)}, [0.95, 0.2, 0.05, 0.8])]\n" +
                "]}",
                network.toString());
