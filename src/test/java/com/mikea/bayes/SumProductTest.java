...
public class SumProductTest {
    ...
    public static Collection<Object[]> parameters() {
        return asList(new Object[][]{
                {new SumProduct.MinNeighborsStrategy()},
                {new SumProduct.MinWeightStrategy()},
                {new SumProduct.MinFillStrategy()},
        });
    }


    public SumProductTest(SumProduct.VarOrderStrategy strategy) {
    ...
    public void testSumProduct() throws Exception {
        ...
        assertEquals("Factor({}, [1.0])",
                sumProductVariableElimination(newArrayList(var1, var2, var3), newArrayList(f1, f2, f3), strategy).toString());
    }
}
